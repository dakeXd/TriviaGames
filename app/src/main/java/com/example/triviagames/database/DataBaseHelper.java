...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private void loadDatabase(SQLiteDatabase db){
        ...
        addOne(db, new QuestionModel(-1, 1, 1, 2, "¿Como se llama la institucion mental que sirve de escenario a Outlast?", "mountmassive_foto", new String[]{"Mount Massive", "Hospital Estatal de Filadelfia", "Hospital Severalls", "Hospital Whittingham"}, new int[]{1,0,0,0}));
        ...
        addOne(db, new QuestionModel(-1, 1, 0, 2, "Quien dijo: La guerra es donde los jóvenes y estúpidos son manipulados por los viejos para matarse entre ellos.", null, new String[]{"Boris Lockhart", "William Bishop", "Thomas Hildern", "Niko Bellic"}, new int[]{0,0,0,1}));
        ...
        addOne(db, new QuestionModel(-1, 1, 1, 3, "¿Cual es el nombre del siguiente personaje?", "mannycalavera_image", new String[]{"Santiago Calavera", "Manny Calavera", "Larry Calavera", "Manuel Calavera"}, new int[]{0,1,0,0}));
